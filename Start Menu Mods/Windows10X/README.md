...
⚠️ The profile button has been removed but the power button has been moved into the search bar and given the microphone icon.
...
```json
{
  ...
  "controlStyles[5].styles[0]": "Margin=79,3,79,43",
  ...
  "controlStyles[7].styles[0]": "Background:=<AcrylicBrush TintColor=\"{ThemeResource SystemChromeMediumColor}\" FallbackColor=\"{ThemeResource SystemChromeMediumColor}\" TintOpacity=\".0\" TintLuminosityOpacity=\".86\"/>",
  ...
  "controlStyles[11].styles[1]": "Margin=81,35,81,3",
  "controlStyles[11].styles[2]": "BorderThickness=1,1,1,6.5",
  "controlStyles[11].styles[3]": "Height=48",
  "controlStyles[12].target": "Border#AppBorder",
  "controlStyles[12].styles[0]": "Background:=<AcrylicBrush TintColor=\"{ThemeResource SystemChromeMediumColor}\" FallbackColor=\"{ThemeResource SystemChromeMediumColor}\" TintOpacity=\".0\" TintLuminosityOpacity=\".86\"/>",
  ...
  "controlStyles[14].styles[0]": "Margin=81,35,81,10",
  ...
  "controlStyles[23].styles[2]": "Margin=0,25,0,0",
  ...
  "controlStyles[29].styles[0]": "Margin=0,111,0,-64",
  ...
  "controlStyles[33].styles[1]": "BorderThickness=1,1,1,6.5",
  ...
  "controlStyles[52].styles[2]": "MaxWidth=742",
  ...
  "controlStyles[57].target": "Windows.UI.Xaml.Controls.GridView#RecommendedList",
  ...
  "webContentStyles[0].target": "#qfPreviewPane, .leftPill::before, #temporaryMessages, .scope-with-background__backButton, #gr11, #pp_Share, #pp_Review, #chatButtonRight, .curatedSettingsGroup, .scope-with-background__rightCaret, #topHitHeader",
  ...
  "controlStyles[33].styles[3]": "Background@CheckedPointerOver:=<SolidColorBrush Color=\"{ThemeResource ControlFillColorSecondary}\"/>",
  "controlStyles[33].styles[4]": "Background@PointerOver:=<SolidColorBrush Color=\"{ThemeResource ControlFillColorSecondary}\"/>",
  ...
  "controlStyles[44].styles[1]": "Transform3D:=<CompositeTransform3D TranslateX=\"-32\" />",
  ...
  "webContentStyles[7].target": "#root:not(.zeroInput19H1):not(.fileExplorer) .topResults .openPreviewPaneBtn .iconContent, .openPreviewIcon .iconContent.cortanaFontIcon",
  "webContentStyles[7].styles[0]": "font-size: 10px !important",
  "controlStyles[33].styles[5]": "BorderBrush:=<LinearGradientBrush StartPoint=\"0,0\" EndPoint=\"0,1\"><GradientStop Color=\"#06000000\" Offset=\"0.84\" /><GradientStop Color=\"#10000000\" Offset=\"0.85\" /><GradientStop Color=\"#00000000\" Offset=\"1.0\" /></LinearGradientBrush>",
  "controlStyles[11].styles[4]": "BorderBrush:=<LinearGradientBrush StartPoint=\"0,0\" EndPoint=\"0,1\"><GradientStop Color=\"#06000000\" Offset=\"0.84\" /><GradientStop Color=\"#10000000\" Offset=\"0.85\" /><GradientStop Color=\"#00000000\" Offset=\"1.0\" /></LinearGradientBrush>",
  "controlStyles[33].styles[6]": "Background@CheckedPointerOver:=<SolidColorBrush Color=\"{ThemeResource ControlFillColorSecondary}\"/>",
  "controlStyles[33].styles[7]": "Background@Checked:=<SolidColorBrush Color=\"{ThemeResource ControlFillColorDefault}\"/>",
  "controlStyles[51].styles[1]": "BorderThickness=0,1,0,0",
  "controlStyles[51].styles[2]": "BorderBrush:=<SolidColorBrush Color=\"{ThemeResource ControlFillColorDefault}\"/>",
  "controlStyles[12].styles[3]": "BorderBrush:=<SolidColorBrush Color=\"{ThemeResource ControlStrokeColorDefault}\"/>",
  "controlStyles[7].styles[3]": "BorderBrush:=<SolidColorBrush Color=\"{ThemeResource ControlStrokeColorDefault}\"/>",
  "theme": "",
  "controlStyles[59].target": "StartDocked.PowerOptionsView#PowerButton",
  "controlStyles[59].styles[0]": "Margin=-68,-1190,0,0",
  ...
  "controlStyles[61].target": "Windows.UI.Xaml.Controls.MenuFlyoutItem",
  "controlStyles[61].styles[0]": "CornerRadius=0",
  "controlStyles[61].styles[1]": "Margin=-4,-2,-4,-2",
  "controlStyles[62].target": "Windows.UI.Xaml.Controls.GridViewItem > Border#ContentBorder > Grid#DroppedFlickerWorkaroundWrapper",
